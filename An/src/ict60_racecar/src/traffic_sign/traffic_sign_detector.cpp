...
TrafficSignDetector::TrafficSignDetector(){
    ...
    model = cv::Algorithm::load<cv::ml::SVM>(ros::package::getPath("ict60_racecar") + std::string("/data/svm_an_rbf.xml"));
...
void TrafficSignDetector::trafficSignDetect(const cv::Mat & input, std::vector<TrafficSign> &traffic_signs){
