...
TrafficSignDetector::TrafficSignDetector(){
    ...
    model = cv::Algorithm::load<cv::ml::SVM>("../../DATA/models/svmModel.xml");
...
void TrafficSignDetector::trafficSignDetect(cv::Mat frame, std::vector<TrafficSign> &traffic_signs){
